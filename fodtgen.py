...
creation_date                 = "2023-12-29 15:49:57"
doc_title                     = "Titel"
...
def table_row_fodt(out, org, trans, col3text, even_odd):
  ...
  right_break = """</text:p><text:p text:style-name="translation_right_text">"""
  right_block = trans.replace(fodt_linebreak, right_break)

  out.write("""
    <table:table-row table:style-name="translation_row">

     <table:table-cell table:style-name="translation_counter_cell{0}">
       <text:p text:style-name="translation_counter_text">{1}</text:p>
     </table:table-cell>

     <table:table-cell table:style-name="translation_left_cell{2}">
       <text:p text:style-name="translation_left_text">{3}</text:p>
     </table:table-cell>

     <table:table-cell table:style-name="translation_right_cell{4}">
...
""".format(bg, cell_counter, bg, left_block, bg, right_block))
  ...
  if col3text is not None:
    ...
    out.write("""
     <table:table-cell table:style-name="translation_3rd_cell{0}">
       <text:p text:style-name="translation_3rd_text">{1}</text:p>
     </table:table-cell>
""".format(bg, col3_block))
