...
def bad_state_for_left(ln):
  ...
  return                     "Wrong state für left in line {0}".format(ln)
...
def bad_state_for_center(ln):
  ...
  return                     "Wrong state für middle in line {0}".format(ln)
...
def bad_state_for_right(ln):
  ...
  return                     "Wrong state für right in line {0}".format(ln)
...
def bad_state_for_end(ln):
  ...
  return                     "Wrong state für end in line {0}".format(ln)
